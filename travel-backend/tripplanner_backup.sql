...
\restrict Uv6VZswwrYh0G6mbuunhREnGj97rignOP5AbJLpEOjAmsG37ifYveYkW5gSzbwM
...
--
-- Name: ve_diadiem_lichtrinh; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.ve_diadiem_lichtrinh (
    id integer NOT NULL,
    ve_id integer NOT NULL,
    lichtrinh_nguoidung_diadiem_id integer NOT NULL,
    ngaytao timestamp(6) without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL
);


ALTER TABLE public.ve_diadiem_lichtrinh OWNER TO postgres;

--
-- Name: ve_diadiem_lichtrinh_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.ve_diadiem_lichtrinh_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.ve_diadiem_lichtrinh_id_seq OWNER TO postgres;

--
-- Name: ve_diadiem_lichtrinh_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.ve_diadiem_lichtrinh_id_seq OWNED BY public.ve_diadiem_lichtrinh.id;


--
-- Name: ve_nguoidung; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.ve_nguoidung (
    ve_id integer NOT NULL,
    nguoidung_id integer NOT NULL,
    tieu_de character varying(255) NOT NULL,
    loai_ve character varying(50),
    ngay_su_dung date,
    ghi_chu text,
    file_url text,
    kieu_file character varying(100),
...
ALTER TABLE public.ve_nguoidung OWNER TO postgres;

--
-- Name: ve_nguoidung_ve_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.ve_nguoidung_ve_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.ve_nguoidung_ve_id_seq OWNER TO postgres;

--
-- Name: ve_nguoidung_ve_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.ve_nguoidung_ve_id_seq OWNED BY public.ve_nguoidung.ve_id;
...
--
-- Name: ve_diadiem_lichtrinh id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.ve_diadiem_lichtrinh ALTER COLUMN id SET DEFAULT nextval('public.ve_diadiem_lichtrinh_id_seq'::regclass);


--
-- Name: ve_nguoidung ve_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.ve_nguoidung ALTER COLUMN ve_id SET DEFAULT nextval('public.ve_nguoidung_ve_id_seq'::regclass);
...
7d9be7a2-ff39-4b78-9dd4-75684e1abc37	d6512fef4d94a4fc51fd0be2da8a6f6dc5a1fa64807913f26a2d64adbb24c0c9	2026-04-14 11:42:48.320783+07	20260414044248_add_ticket_library	\N	\N	2026-04-14 11:42:48.241768+07	1
\.
...
12	VZKDoK_WvJxwvEkz_ka9x3G9YyycRbptXaxVCKLliW9ao0EUMkBu79nGsdAKMUY3wWzVoy4RBushZQU8S_36__mtmYxW2bYzRaKxaTox8hLpplkka5RqMjGu-QTH3G7rM	Gánh - Đặc sản Nha Trang	Gánh - Đặc sản Nha Trang, 4 Hẻm 58 Phạm Ngọc Thạch, Võ Thị Sáu, Quận 3, Hồ Chí Minh	10.786189610000065	106.69251572900004	\N	restaurant	\N	\N	200000	2026-04-14 10:54:40.544	Quận 3	Nhà hàng Gánh, đặc sản Nha Trang	6	APPROVED
4	1JZHoWVbczxw1KUvS16Wc_C-UozRfcqxve6CjI3Venut7jaJVXE-doEXbSDQLbZGLRbGgPVeKYcJz1-1U6YKKokXWoRQ	Cafe độc & lạ	16 Đ. Số 9, Phường 16, An Hội Đông, Hồ Chí Minh	10.8463543	106.669672	\N	cafe	\N	\N	100000	2026-04-14 05:33:17.287	Gò Vấp	Cà phê, yên tĩnh, học bài	6	APPROVED
\.
...
3	8	123	planning	2026-04-07 14:41:25.161	\N	\N
...
1	3	1	\N	\N	\N	1	1
3	4	1	23:59:00	60	\N	6	1
2	12	1	08:10:00	60	\N	10	1
\.
...
5	3	1	08:00	HMK Hà Nội	21.0013586	105.8454374	MIKADO SUSHI MỸ ĐÌNH	21.0146226	105.7746683
10	2	1	08:00	M Village	10.78836644100005	106.67638642600008	Nhà thờ Đức Bà	20.424540080000043	106.17770842500005
\.
...
--
-- Data for Name: ve_diadiem_lichtrinh; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.ve_diadiem_lichtrinh (id, ve_id, lichtrinh_nguoidung_diadiem_id, ngaytao) FROM stdin;
8	3	10	2026-04-14 10:54:38.724
\.


--
-- Data for Name: ve_nguoidung; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.ve_nguoidung (ve_id, nguoidung_id, tieu_de, loai_ve, ngay_su_dung, ghi_chu, file_url, kieu_file, cloudinary_id, trang_thai, ngaytao, chi_tiet) FROM stdin;
1	8	vé xe bay	bus	2026-04-15	zxc	https://res.cloudinary.com/dmnj7vqow/image/upload/v1776142975/ve-nguoidung/8/1776142970362-WIN_20260305_22_32_28_Pro.jpg	image/jpeg	ve-nguoidung/8/1776142970362-WIN_20260305_22_32_28_Pro	t	2026-04-14 05:02:55.32	\N
2	8	zxc	\N	2026-04-15	1	\N	\N	\N	f	2026-04-14 05:15:19.714	\N
3	8	Vé xe khách Điện tử - Phuong Trang Bus Lines	bus	2026-04-20	Mã số vé: PT88992211. Điểm đón: Bến Xe Miền Tây - Quầy vé số 31. Điểm trả: Bến Xe Liên Tỉnh Đà Lạt. Trạng thái thanh toán: Đã thanh toán qua Ví MoMo. Mã QR: FUTA-HCM-DL-200426-B12.	\N	\N	\N	t	2026-04-14 10:42:31.656	{"so_ghe": "B12 (Giường nằm tầng dưới)", "gia_tien": "300.000 VNĐ", "tuyen_duong": "TP. Hồ Chí Minh - Đà Lạt", "gio_khoi_hanh": "22:30", "thoi_gian_den": ""}
\.
...
SELECT pg_catalog.setval('public.diadiem_diadiem_id_seq', 26, true);
...
SELECT pg_catalog.setval('public.lichtrinh_nguoidung_diadiem_id_seq', 10, true);
...
SELECT pg_catalog.setval('public.lichtrinh_nguoidung_lichtrinh_nguoidung_id_seq', 3, true);
...
SELECT pg_catalog.setval('public.lichtrinh_nguoidung_ngay_id_seq', 10, true);
...
--
-- Name: ve_diadiem_lichtrinh_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.ve_diadiem_lichtrinh_id_seq', 8, true);


--
-- Name: ve_nguoidung_ve_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.ve_nguoidung_ve_id_seq', 3, true);
...
--
-- Name: ve_diadiem_lichtrinh ve_diadiem_lichtrinh_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.ve_diadiem_lichtrinh
    ADD CONSTRAINT ve_diadiem_lichtrinh_pkey PRIMARY KEY (id);


--
-- Name: ve_nguoidung ve_nguoidung_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.ve_nguoidung
    ADD CONSTRAINT ve_nguoidung_pkey PRIMARY KEY (ve_id);
...
--
-- Name: ve_diadiem_lichtrinh ve_diadiem_lichtrinh_lichtrinh_nguoidung_diadiem_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.ve_diadiem_lichtrinh
    ADD CONSTRAINT ve_diadiem_lichtrinh_lichtrinh_nguoidung_diadiem_id_fkey FOREIGN KEY (lichtrinh_nguoidung_diadiem_id) REFERENCES public.lichtrinh_nguoidung_diadiem(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: ve_diadiem_lichtrinh ve_diadiem_lichtrinh_ve_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.ve_diadiem_lichtrinh
    ADD CONSTRAINT ve_diadiem_lichtrinh_ve_id_fkey FOREIGN KEY (ve_id) REFERENCES public.ve_nguoidung(ve_id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: ve_nguoidung ve_nguoidung_nguoidung_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.ve_nguoidung
    ADD CONSTRAINT ve_nguoidung_nguoidung_id_fkey FOREIGN KEY (nguoidung_id) REFERENCES public.nguoidung(nguoidung_id) ON UPDATE CASCADE ON DELETE CASCADE;
...
\unrestrict Uv6VZswwrYh0G6mbuunhREnGj97rignOP5AbJLpEOjAmsG37ifYveYkW5gSzbwM
